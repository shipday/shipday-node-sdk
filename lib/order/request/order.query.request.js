...
const order_state_1 = __importDefault(require("../types/order.state"));
class OrderQueryRequest {
    ...
    isValid() {
        ...
        if (this.orderStatus)
            if (Object.values(order_state_1.default).indexOf(this.orderStatus) === -1) {
    ...
    getRequestBody() {
        ...
        return Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (startTimeInISO8601 !== null && { startTime: startTimeInISO8601 })), (endTimeInISO8601 !== null && { endTime: endTimeInISO8601 })), (this.orderStatus !== null && { orderStatus: this.orderStatus })), (this.startCursor !== null && { startCursor: this.startCursor })), (this.endCursor !== null && { endCursor: this.endCursor }));
    }
}
exports.default = OrderQueryRequest;
