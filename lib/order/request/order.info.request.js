...
const payment_method_1 = __importDefault(require("../types/payment.method"));
const card_type_1 = __importDefault(require("../types/card.type"));
const address_1 = __importDefault(require("./address"));
class OrderInfoRequest {
    constructor(orderNumber, customerName, customerAddress, customerEmail, customerPhoneNumber, restaurantName, restaurantAddress) {
    ...
    setPaymentMethod(paymentOption) {
        if (paymentOption && Object.values(payment_method_1.default).indexOf(paymentOption) >= 0) {
    ...
    setCreditCardType(cardType) {
        if (cardType && Object.values(card_type_1.default).indexOf(cardType) >= 0) {
    ...
    getRequestBody() {
        ...
        if (!this.customerAddress || !(this.customerAddress instanceof address_1.default))
        ...
        if (!this.restaurantAddress || !(this.restaurantAddress instanceof address_1.default))
...
exports.default = OrderInfoRequest;
