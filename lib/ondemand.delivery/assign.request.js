...
class AssignRequest {
    ...
    getRequestBody() {
        return Object.assign(Object.assign({ 'name': this.name, 'orderId': this.orderId }, (this.tip !== null && { tip: this.tip })), (this.estimateReference !== null && { estimateReference: this.estimateReference }));
    }
}
